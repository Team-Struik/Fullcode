...
function Preview(props: {
    ...
    const get_price_sink = () => {
        if (data) {
            for (let i = 0; i < data.length; i++) {
                if (data[i].Materiaalsoort === props.Data.selectedMaterial) {
                    if (props.Data.isSelectedUndermountSink) return data[i].Uitsparing_onderbouw;
                    else if (props.Data.isSelectedInlaySink) return data[i].Uitsparing_inleg;
                    else if (props.Data.isSelectedCoarseSink) return data[i].Uitsparing_ruw;
                }
            }
        }
    };
    ...
    return (
        <div className="rounded-md bg-clip-content bg-white px-32 py-8 h-screen">
            ...
            <div className='flex items-center justify-center'>
                <div>
                    <div className='border-b-black px-12 flex'>
                        ...
                        <p className='w-52 text-xs font-bold text-black'>Hoeveelheid/toegevoegd</p>
                    ...
                    <div className='px-12 flex pb-1'>
                        ...
                        <p className='w-52 text-xs font-bold text-black'>{props.Data.width! * props.Data.length!} vierkante meter</p>
                    ...
                    <div className='px-12 flex pb-1'>
                        ...
                        <p className='w-52 text-xs font-bold text-black'>{props.Data.isSelectedSinkHole ? "Ja" : "Nee"}</p>
                    ...
                    <div className='px-12 flex pb-1'>
                        ...
                        <p className='w-52 text-xs font-bold text-black'>{props.Data.isSelectedSoapDispender ? "Ja" : "Nee"}</p>
                        <p className='w-20 text-xs font-bold text-black'>€10.70</p>
                    ...
                    <div className='px-12 flex pb-1'>
                        <p className='pr-16 text-xs font-bold text-black'>9</p>
            ...
            <p className='text-xs text-gray-400 text-center align-bottem px-12 pt-5'>Bij verdere vragen kunt u ons bereiken op lorem@ipsum.com</p>
        </div>
    );
}
